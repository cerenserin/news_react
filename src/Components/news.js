...
export default class news extends Component {
 ...
 async componentDidMount(){
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=${this.props.category}&apiKey=3834e377e7dd426bb213be07209df34e&page=1&pageSize=${this.props.pagesize}`;
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=us&category=${this.props.category}&apiKey=3834e377e7dd426bb213be07209df34e&page=${this.state.page - 1}&pageSize=${this.props.pagesize}`;
    ...
    return (
      ...
      <div className='container mt-5 ps-5 pt-5'>
        ...
        !this.state.loading && this.state.articles.map((element)=>{
           ...
           return (
           <div className='col-sm-3 mb-5 ' key={element.url}>
